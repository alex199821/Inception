...
touch srcs/.env
echo "DOMAIN_NAME=auplisas.42.fr" > srcs/.env
echo "CERT_=./requirements/tools/auplisas.42.fr.crt" >> srcs/.env
echo "KEY_=./requirements/tools/auplisas.42.fr.key" >> srcs/.env
...
echo ".git" > srcs/requirements/nginx/.dockerignore
echo ".env" >> srcs/requirements/nginx/.dockerignore
